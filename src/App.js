...
export default function App() {
  ...
  const [newItem, setNewItem] = useState({ name: "", shares: "", avgPrice: "", currentPrice: "" });
  ...
  return (
    <div style={{ padding: "2rem", maxWidth: "600px", margin: "0 auto" }}>
      ...
      <div style={{ marginBottom: "1rem", border: "1px solid #ddd", padding: "1rem" }}>
        <h2>종목 추가</h2>
        <input name="name" placeholder="종목명" value={newItem.name} onChange={handleChange} />
        <input name="shares" placeholder="보유 수량" value={newItem.shares} onChange={handleChange} />
        <input name="avgPrice" placeholder="매수 단가" value={newItem.avgPrice} onChange={handleChange} />
        <input name="currentPrice" placeholder="현재가" value={newItem.currentPrice} onChange={handleChange} />
